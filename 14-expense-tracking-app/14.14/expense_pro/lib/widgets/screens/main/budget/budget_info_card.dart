...
class BudgetInfoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String remainingAmount =
        '${(estimatedAmount - usedAmount) >= 0 ? ((estimatedAmount - usedAmount).toString().endsWith('0') ? (estimatedAmount - usedAmount).toInt() : (estimatedAmount - usedAmount)) : 0}';
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '\$${usedAmount.toString().endsWith('0') ? usedAmount.toInt() : usedAmount} of \$${estimatedAmount.toString().endsWith('0') ? estimatedAmount.toInt() : estimatedAmount}',
              style: GoogleFonts.inter(
                fontSize: 16,
                fontWeight: FontWeight.w500,
