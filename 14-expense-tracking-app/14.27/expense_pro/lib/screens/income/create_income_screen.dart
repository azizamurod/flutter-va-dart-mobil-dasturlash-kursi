...
class CreateIncomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    context
        ...
        .initializeCreateScreen(TransactionTypes.income);

    return Scaffold(
      backgroundColor: const Color.fromRGBO(0, 168, 107, 1),
      appBar: CustomAppBar(title: AppLocalizations.of(context)!.income),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomButton(
                        ...
                        onTap: () =>
                            transactionsProvider.createTransaction(context,),
                      ),
                    ],
                  ),
                ),
